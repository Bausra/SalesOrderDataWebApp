...
var connectionString = builder.Configuration.GetConnectionString("SalesOrderDataWebAppDbConnectionString");
...
builder.Services.AddAutoMapper(typeof(SalesOrderDataAppMapper)); 
